...
[![Streamlit](https://img.shields.io/badge/Streamlit-Demo-red.svg)](https://kqiwcxqxcduzilfmnzxzme.streamlit.app)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)

> **🚀 Live Demo:** [Try the classifier now!](https://kqiwcxqxcduzilfmnzxzme.streamlit.app)

A state-of-the-art deep learning system that classifies products by combining **computer vision** and **natural language processing**. Achieved **87.56% accuracy** using multimodal fusion of image (ConvNeXtV2) and text (MiniLM) embeddings.

**Developed by:** [Andres Benavides](https://github.com/ajbenc)
...
|-------|----------|----------|-------------|
| 🔗 **Multimodal** | **87.56%** | **87%** | Image + Text fusion |
| 📝 **Text Only** | **94.16%** | **94%** | Zero overfitting |
| 🖼️ **Image Only** | **82.00%** | **81%** | Synthetic data augmented |

---

## ✨ Features

- 🎨 **Interactive Web Demo** - Try the classifier with your own products
- 🧠 **Multimodal AI** - Combines vision and language understanding
- 🚀 **Production Ready** - Docker support, comprehensive testing
- 📊 **Visual Results** - Confidence scores and top-N predictions
...
**Technologies:**
- **Vision:** ConvNeXtV2 (Hugging Face Transformers)
...
Visit the [**live demo**](https://kqiwcxqxcduzilfmnzxzme.streamlit.app) to classify products instantly!

The demo showcases **text-only classification** with **94.16% accuracy** - select a product category, choose a product, and see the AI prediction in real-time.

### Run Locally

```bash
# Clone repository
git clone https://github.com/ajbenc/Multimodal-Product-Classification-System.git
cd Multimodal-Product-Classification-System
...
# Load models
vision_model = FoundationalCVModel('convnextv2_tiny')
nlp_model = HuggingFaceEmbeddings('sentence-transformers/all-MiniLM-L6-v2')

# Extract features
image_emb = vision_model.predict(product_image)
text_emb = nlp_model.get_embedding(product_description)

# Classify
prediction = classifier.predict([text_emb, image_emb])
```
...
- ✅ Handled channels-first vs channels-last format conversions
- ✅ Achieved zero overfitting through strategic regularization
- ✅ Implemented safetensors compatibility workarounds

### Key Techniques
- **Early Fusion Architecture** for multimodal learning
- **L2 Regularization + Dropout** to prevent overfitting
- **Synthetic Data Augmentation** for image model
- **Lambda Layer Wrapping** for Transformer integration
...
*Model training convergence showing excellent generalization*
